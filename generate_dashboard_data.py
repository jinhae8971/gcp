...
SECTOR_DEFS = [
    ...
    {"id": "finance",   "name": "금융",           "theme": "안정",
     "tickers": ["105560", "055550", "032830", "086790", "138930", "316140", "024110", "139130", "001450", "016360"]},  # +삼성증권
    ...
    {"id": "power_eq",  "name": "전력기기",       "theme": "신규",
     "tickers": ["267260", "010120", "298040", "006340", "062040", "267290", "001440", "103590"]},  # +일진전기
    {"id": "holding",   "name": "지주/기타대형",  "theme": "안정",
     "tickers": ["402340", "034730", "028260", "003550", "000880", "001040", "047040", "375500", "006360", "047810", "011200", "006260"]},  # +LS
]

# ETF 식별 패턴 (수급 랭킹에서 제외용)
ETF_NAME_PATTERNS = [
    "KODEX", "TIGER", "KBSTAR", "KOSEF", "ARIRANG", "HANARO", "KINDEX", "TREX",
    "ACE ", "PLUS ", "WOORI ", "FOCUS ", "KIWOOM ", "SOL ", "RISE ", "RISE",
    "선물", "인버스", "레버리지", "ETN", "ETF",
]
